...
Например, если вы используете Nunjucks в качестве HTML-препроцессора, вас необходимо создать файлы `page.index.njk.tpl` и `page.markup.njk.tpl` и указать расширение `njk` в поле `yellfy.html`
